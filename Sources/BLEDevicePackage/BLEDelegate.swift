...
public protocol BLEDelegate: AnyObject {
    ...
    func didUpdateSensorStatusLeft(status: Int)
    func didUpdateSensorStatusRight(status: Int)
    func didUpdateBatteryLeft(percent: Int)
    func didUpdateBatteryRight(percent: Int)
